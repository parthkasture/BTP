...
class LteRadioBearerTag : public Tag
{
  public:
    ...
    /**
     * Create a LteRadioBearerTag with the given RNTI, LC id, layer, srcL2Id and dstL2Id use for
     * Sidelink \param rnti the RNTI \param lcId the LCID \param srcL2Id the layer2 id of the source
